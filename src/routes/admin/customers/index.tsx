...
const CustomerCharts = lazy(() => import('#/components/admin/CustomerCharts'));
  ...
  return (
    <main className="page-wrap py-8">
      ...
      <Suspense fallback={<ChartPlaceholder />}>
        <CustomerCharts monthlyJoinData={monthlyJoinData} managerSalesData={managerSalesData} />
      </Suspense>
                  ...
                  {filteredCustomers.length > 0 ? (
                    filteredCustomers.map((customer) => (
                      ...
                      >
                        ...
                        <TableCell>{customerStatusLabels[customer.status]}</TableCell>
